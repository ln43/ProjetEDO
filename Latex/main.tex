...
On sait que la population se répartie souvent selon une gaussienne à un endroit. Pour cela, on considère comme condition initiale une population $u_0$ pour $x\in[-10,10]$ et 0 sinon. (On fait varier $u_0$ en fonction des simulations).
