...
\begin{equation*}
>>>>>>> 0684e3a7e56e4f1ca11278bb0c9c091e3506b87f
u(t,x)=U(x-ct)=U(z)
\label{Eq1}
\end{equation}
...
On décide ici de modéliser des barrières géographiques telles que des montagnes, le pôle Nord qui pourrait avoir une influence sur la survie et la diffusion des population.
Pour cela on considère notre environnement comme hétérogène. On fait varier la capacité du milieu en fonction de la position dans l'espace.\\
...
=======
\noindent \textbf{Effet d'un changement de climat}
On modélise ici le changement de climat entre deux zones, par exemple avec le pôle Nord où la température est plus faible et les ressources moins importantes. On prend donc un K très petit sur une large zone. 
>>>>>>> 0684e3a7e56e4f1ca11278bb0c9c091e3506b87f
