...
réaction-diffusion sous forme d'un front d'onde qui se déplace dans l'espace à vitesse constante.
...
\noindent On peut montrer (Voir Annexe 1) que ~\eqref{EqGen} est équivalent à :
...
\underline{Étude des fronts d'ondes}\\
...
\end{equation}
U est la forme de l'onde et c sa vitesse.\\
On peut montrer (Voir Annexe 1) que ~\eqref{EqGen} est équivalent à :
\begin{equation}
...
On observe que la population se répand dans la zone où elle peut survivre.
...
\begin{figure}[H]
    ...
    \caption{Diffusion 2D: t=0, t=500, t=5000}
\end{figure}
On se situe dans le cas où $A<0.5$ et $u_0<A$. La population évolue sensiblement de la même manière que dans le cas 1.1. En effet, bien que la diffusion évolue, c'est ici l'effet Allee qui est responsable de l'extinction de la population, indépendamment de la diffusion.
...
\begin{figure}[H]
    ...
    \caption{Diffusion 2D: t=0, t=500, t=5000}
\end{figure}
On peut comparer ce cas au cas 1.2. On se situe en effet également à $A>0.5$ et $u_0>A$: La population va s'étendre et l'équilibre 1 va peu à peu envahir tout l'espace. Cependant, étant donné que la constante de diffusion a diminué, cet envahissement sera beaucoup plus long à avoir lieu. Ceci explique que pour le même intervalle de temps, une surface plus petite soit occupée par notre population.
